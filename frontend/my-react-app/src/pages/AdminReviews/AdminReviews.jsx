...
import {
  getAllReviews,
  deleteReviews,
} from "../../services/apartmentsReviews.service";
    ...
    <>
      <div className="container-fluid row">
        ...
        <main className="name col ms-5 mt-5 mb-5">
          ...
          <table className="table table-striped table-hover mb-5 table-responsive">
            <thead>
              <tr className="table-dark">
                ...
                <th className="align-middle text-center col">
                  Documento legal
                </th>
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item.id}>
                  ...
                  <td
                    className={
                      item.postedStatus === "no"
                        ? "table-danger align-middle text-center"
          ...
          <button type="button" className="btn btn-naranja w-100">
