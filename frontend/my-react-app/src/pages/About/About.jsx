        ...
        <>
            ...
            <div className="container mt-5 mb-5">
                ...
                <ul>
                    ...
                    <li>Teléfono: Si prefieres hablar directamente con nosotras, puedes llamarnos al [número de teléfono]. Estamos disponibles para atenderte de [horario de atención].</li>
                </ul>
